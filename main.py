    ...
    if username != "" :
        if username != "None":
            ...
            sql = "INSERT INTO user(Username, Container, Time ,Date) VALUES('%s', '%s', '%s', '%s')" % (username,
             container, time, day)
            ins = "INSERT  INTO result(Date,Van01,Van02,Van03,Van04,Van05,Van06,Van07,Van08,Van09,Van10,Bus01,Bus02,Bus03,Bus04,Bus05) VALUES('%s', '%s', '%s', '%s','%s', '%s', '%s', '%s','%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')" % (day,Van01,Van02,Van03,Van04,Van05,Van06,Van07,Van08,Van09,Van10,Bus01,Bus02,Bus03,Bus04,Bus05)
            cursor = connection.cursor()
            cursor.execute(sql)
            cursor.execute(ins)
            connection.commit()
